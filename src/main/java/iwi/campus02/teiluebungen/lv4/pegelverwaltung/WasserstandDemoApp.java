...
public class WasserstandDemoApp {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Wasserstand> ws = wmgr.findAllByGewaesser("Donau");
        System.out.println("Donau -> " + ws);

        w = wmgr.findLastWasserstand("Enns");
        System.out.println("newest Enns -> " + w);

        ws = wmgr.findForAlarmierung();
        System.out.println("alarm -> " + ws);

        ws = wmgr.findByZeitpunkt(130_000, 190_000, "Donau");
        System.out.println("Donau innerhalb Zeitraum -> " + ws);

        ws = wmgr.findByZeitpunkt(80_000, 90_000, "Mur");
